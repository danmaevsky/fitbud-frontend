...
export default function RecipeBuilderPage() {
    ...
    const [recipes , recipeMethods] = useArray([])
    ...
    const addFoodToRecipe = (_id, metricQuantity, numServings, servingName) => {
        recipeMethods.push({ foodId: _id , servingName: servingName , numServings: numServings, quantityMetric: metricQuantity })
    }
            ...
            <div id="dashboard-page-content">
                ...
                <div>
                    { (foodId !== "" || renderFoodInfo ) ? (
                        <>
                            <div id="dashboard-food-searchbox-empty">
                            </div>
                            <div id="food-search-island">
                                <div id="food-island-buttons">
                                    <button id="food-island-back-arrow" onClick={ () => {setFoodId("")} } >
                                        <img src={backArrow} alt="back arrow" />
                                        Go Back
                                    </button>
                                    <button id="food-island-add" onClick={ addFoodToRecipe } >
                                        <img src={plusSign} alt="add arrow" />
                                        Add Food
                                    </button>
                                </div>
                                {renderFoodInfo ? <FoodInfo foodResponse={foodResponse} 
                                metricQuantity={metricQuantity} setMetricQuantity={setMetricQuantity}
                                numServings={numServings} setNumServings={setNumServings}
                                /> : null}
                            </div>
                        </>
                    ) : (
...
function RecipeItems(props) {
    ...
    const {recipes , recipeMethods} = props
...
function FoodInfo(props) {
    ...
    const { foodResponse, metricQuantity, setMetricQuantity, numServings, setNumServings, servingName, setServingName} = props;
